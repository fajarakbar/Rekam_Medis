...
if (isset($_POST['cari_rm_lama'])) {
  ...
  $pattern    = $_POST['nama'];
  $field  = "nama_pasien";
}elseif (isset($_POST['cari_tanggal'])) {
  $pattern    = $_POST['tanggal'];
  $field  = "tgl_masuk";
}
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="tampil">
        ...
        <form class="" action="" method="post">
          <table border="0" cellpadding="10">
            ...
            <tr>
              <td>
                <label for="" style="color:#35a82d;"><b>Cari Tanggal</b></label>
              </td>
              <td>:</td>
              <td>
              ...
              <td>
                <input type="submit" class="btn btn-success" name="cari_tanggal" value="Cari">
              </td>
            </tr>
            <tr>
              <td>
